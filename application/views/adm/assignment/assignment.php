                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                                        <a href="'. site_url("admin/assignment/" . $item->NPM_MHS) .'" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Worksheet"><i class="bi bi-archive-fill"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        ';
