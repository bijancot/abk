                        ...
                        <tbody>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                   <img src="<?= site_url()?>/assets/adm/images/products/11.png" alt="">
                                </div>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                   <img src="<?= site_url()?>/assets/adm/images/products/07.png" alt="">
                                </div>
                                <div class="product-info">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                   <img src="<?= site_url()?>/assets/adm/images/products/17.png" alt="">
                                </div>
                                <div class="product-info">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                   <img src="<?= site_url()?>/assets/adm/images/products/04.png" alt="">
                                </div>
                                <div class="product-info">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                   <img src="<?= site_url()?>/assets/adm/images/products/10.png" alt="">
                                </div>
                                <div class="product-info">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                   <img src="<?= site_url()?>/assets/adm/images/products/12.png" alt="">
                                </div>
                                <div class="product-info">
