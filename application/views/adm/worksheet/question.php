                    ...
                    <form action="">
                        <ul class="list-group" id="demo1" >
                            <li class="list-group-item" data-item="1" >
                                <div data-bs-toggle="collapse" data-bs-target="#collapseExample" style="cursor: pointer;font-weight: 600;font-size: 18px;"><i class="bi bi-grip-vertical handle"></i> Question 1</div>
                            ...
                            <li class="list-group-item" data-item="1" >
                                <div data-bs-toggle="collapse" data-bs-target="#collapseExample2" style="cursor: pointer;font-weight: 600;font-size: 18px;"><i class="bi bi-grip-vertical handle"></i> Question 2</div>
